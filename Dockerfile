...
#RUN DEBIAN_FRONTEND=noninteractive apt-get -yq install python3 python3-pip python3-dev
...
RUN chmod +x mv /etc/nginx/conf.d/default.conf /etc/nginx/conf.d/default.conf.ORIGINAL
